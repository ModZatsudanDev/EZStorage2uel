...
public class EZInventory {
    ...
    public @Nonnull ItemStack getItemsExtractList(EnumListMode mode, boolean roundRobin, InventoryExtractList list,
    ...
    public static boolean stacksEqualOreDict(ItemStack stack1, ItemStack stack2) {
        ...
        boolean third = stack1.getItemDamage() == OreDictionary.WILDCARD_VALUE ||
