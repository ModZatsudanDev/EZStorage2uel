...
/**
 * The JEI stack helper (by mezz), important parts copied here to avoid JEI internal-change crashes. Notable change: No
 * UID cache
 */
public class JEIStackHelper {
    ...
    public String getUniqueIdentifierForStack(@Nonnull ItemStack stack, @Nonnull UidMode mode) {
        ...
        if (mode == UidMode.FULL) {
            ...
            if (nbtTagCompound != null && !nbtTagCompound.getKeySet().isEmpty()) {
