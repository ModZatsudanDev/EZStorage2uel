package modzatsudan.ezstorage.old.jei;
...
import modzatsudan.ezstorage.old.network.MessageRecipeSync;
...
public class RecipeTransferHandler implements IRecipeTransferHandler {
    ...
    public IRecipeTransferError transferRecipe(Container container, IRecipeLayout recipeLayout, EntityPlayer player,
                                               ...
                                               boolean doTransfer) {
        if (doTransfer) {
            Map<Integer, GuiIngredient<ItemStack>> inputs = (Map<Integer, GuiIngredient<ItemStack>>) recipeLayout
                    .getItemStacks().getGuiIngredients();
