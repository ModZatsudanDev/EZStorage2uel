...
public class GuiSecurityBox extends GuiContainerEZ {
    ...
    public void initGui() {
        ...
        for (int i = 0; i < nButtons; i++) {
            ...
            availablePlayers[i] = new ButtonBlue(i + nButtons, k + this.xSize - buttonWidth - 4, l + 30 + i * 15,
                    buttonWidth, 14, "");
        }
    ...
    protected void actionPerformed(GuiButton parButton) {
        ...
        if (parButton.id < nButtons) {
            ...
            EZNetwork.sendSecurePlayerMsg(tileSecure.getWorld(), tileSecure.getPos(),
                    new SecurePlayer(nearbyPlayers.get(parButton.id - nButtons)),
                    true);
        }
    }
