...
public class GuiCheckBoxCustom extends GuiCheckBox {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
        if (this.visible) {
            ...
            GuiUtils.drawContinuousTexturedBox(BUTTON_TEXTURES, this.x, this.y, 0, 46, this.boxWidth, this.height, 200,
                    20, 2, 3, 2,
                    2, this.zLevel);
            ...
            if (this.isChecked())
                this.drawCenteredString(mc.fontRenderer, checkStr, this.x + this.boxWidth / 2 + 1, this.y + 1,
                        14737632);
        }
    }
}
