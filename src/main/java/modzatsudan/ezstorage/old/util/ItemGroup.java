...
public class ItemGroup {
    ...
    public static enum EnumSortMode {
        ...
        INVERSE_COUNT(InverseCountComparator.class, "Count Up",
                "Sorts by ascending item counts, then from Z-A for equal cases."),
        NAME(NameComparator.class, "Name A - Z", "Sorts A-Z, then by descending item counts for equal cases."),
        INVERSE_NAME(InverseNameComparator.class, "Name Z - A",
                "Sorts Z-A, then by ascending item counts for equal cases."),
        MOD_NAME(ModNameComparator.class, "Mod A - Z",
                "Sorts by mod name A-Z, then by descending item counts for equal cases."),
        INVERSE_MOD_NAME(InverseModNameComparator.class, "Mod Z - A",
    ...
    public static class ModNameComparator extends ItemGroupComparator {
        ...
        @Override
        public int compare(ItemGroup group1, ItemGroup group2) {
            String m1 = group1.itemStack.getItem().getRegistryName().getNamespace();
            String m2 = group2.itemStack.getItem().getRegistryName().getNamespace();
