package modzatsudan.ezstorage.old.registry;
...
public interface IRegistryBlock extends IRegistryBase {
    ...
    public default String getShorthandName() {
        return ((Block) this).getTranslationKey().substring(5);
    }

    @SideOnly(Side.CLIENT)
    @Override
    public default void registerRender() {
        ClientRegistryHelper.registerModel(Item.getItemFromBlock((Block) this), 0,
                new ModelResourceLocation(((Block) this).getRegistryName(), "inventory"));
    }
}
