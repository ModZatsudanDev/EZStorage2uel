...
public class RegistryHelper {
    ...
    public static void registerBlock(IRegistryBlock regBlock) {
        ...
        BLOCKS_TO_REGISTER.add(block.setTranslationKey(block.getRegistryName().toString()));
    ...
    public static void registerItem(IRegistryItem regItem) {
        ...
        ITEMS_TO_REGISTER.add(item.setTranslationKey(item.getRegistryName().toString()));
    }
